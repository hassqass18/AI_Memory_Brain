...
- [ ] Fund 1 Prospectus: final review and clean version
- [ ] Scope of Responsibility: finalize and sign
- [ ] Central Asia pipeline: Aibek to confirm top 3 Kazakhstan opportunities
- [ ] Regulatory check: confirm filing requirements (SEC / CFTC / jurisdiction TBD)
- [ ] Roadshow deck: LP pitch presentation (12–15 slides)

## Promotion Criteria

When ready to promote to full project, execute `PROJECT_MEMORY_INIT.md`:
- GP Agreement signed by all parties
- Prospectus approved by all GPs
- Advisory board confirmed (minimum 3 members)
- LP pipeline active (10+ qualified conversations)

---

## Completed

- [x] Fund structure defined ($200M target, 20/8, 10-year LP)
- [x] GP carry allocation agreed (Alex 27%, Hassan 25%, Aibek 25%, Stephen 15%)

...
**Purpose:** Execute at the end of any session working on Provecta Group operations.

---

> **Prompt for AI:** "Execute the ProvectaGroup staging session closure:
>
...
>
> 5. **Update Master-Context.md:** Update engagement status, revenue tracking, and any new document locations.
>
> 6. **Confirm Save:** Verify all files are saved. Remind user to push to GitHub:
>    ```bash
>    cd AI_Memory_Brain
>    git add .
>    git commit -m 'ProvectaGroup staging: {brief description of session work}'
